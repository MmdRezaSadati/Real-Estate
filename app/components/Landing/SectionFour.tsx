...
const SectionFour = () => {
  return (
    <div className="w-full">
      <MainContainer className="flex pt-14 px-28 justify-center items-center gap-5">
        <div className="w-1/2 min-w-[400px] pt-5">
          <div className="relative group min-w-[300px] z-10 -mb-16">
            <SuperSale
              rounded="rounded-t-full"
              padding="px-5 py-6"
              className="absolute -top-2 right-10 w-36 h-40"
            >
              Super Sale$
            </SuperSale>
            <BigImage
        ...
        <div className="w-1/2 pt-14 flex flex-col justify-center items-center gap-10 px-5">
          <XTitle
